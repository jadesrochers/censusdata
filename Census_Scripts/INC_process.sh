...
node csv_todb.js -p 27017 --keyvars "GEO_ID" --db 'census_income_data' --collection 'income_summary' --vars 'GEO_ID,Median_household_income_1979,Median_household_income_1989,Median_household_income_1999,Median_household_income_2009,Mean_household_income_2009' 'Census_INC_2011/INC01.csv.0'

node csv_todb.js -p 27017 --keyvars "GEO_ID" --db 'census_income_data' --collection 'income_summary' --vars 'GEO_ID,Median_family_income_1969,Median_family_income_1979,Median_family_income_1989,Median_family_income_1999,Median_family_income_2009,Mean_family_income_2009' 'Census_INC_2011/INC02.csv.0'

node csv_todb.js -p 27017 --keyvars "GEO_ID" --db 'census_income_data' --collection 'income_summary' --vars 'GEO_ID,Per_capita_income_1969,Per_capita_income_1979,Per_capita_income_1989,Per_capita_income_1999,Per_capita_income_2009'   'Census_INC_2011/INC02.csv.9'
