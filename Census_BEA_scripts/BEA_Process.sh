...
# unzip the downloads
rm Census_BEA_PEN_2011/*
rm Census_BEA_PIN_2011/*
rm BEA_CAINC1_2017/*
rm BEA_CAINC4_2017/*
...
# Use sed to separate out the variables in the historical BEA data
...
node csv_todb.js -p 27017 --keyvars "GEO_ID" --db 'bea_income_data' --collection 'personal_income' --vars 'GEO_ID,Area_name' 'Census_BEA_PEN_2011/PEN01.csv.0'
node csv_todb.js -p 27017 --keyvars "GEO_ID" --db 'bea_income_data' --collection 'personal_income' --vars 'GEO_ID,Area_name' 'Census_BEA_PIN_2011/PIN01.csv.0'
# The non census data may have different locations, so use that too
node csv_todb.js -p 27017 --keyvars "GEO_ID" --db 'bea_income_data' --collection 'personal_income' --vars 'GEO_ID,Area_name' 'BEA_CAINC1_2017/CAINC1_All_Personal_Income_1969_2017.csv'
